...
import com.projetoautomacao.cursomc.service.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Categoria> update(@Valid @RequestBody CategoriaDTO objDto, @PathVariable Integer id) throws Exception {
		Categoria obj = service.fromDTO(objDto);
		obj.setId(id);
